    ...
    <section className="flex justify-center pt-[13vh]">
      <section className="w-[90%] p-5 flex flex-col gap-2.5">
        <div className="flex flex-col items-center justify-center py-20 bg-white">
          ...
          <h2 className="text-2xl font-bold text-[var(--color-800)] mb-3">
          ...
          <button
            onClick={refetch}
            className="px-6 py-3 bg-[var(--addi-color-400)] text-white rounded-lg hover:bg-[var(--addi-color-500)] transition-colors font-medium cursor-pointer"
          >
            Try Again
          </button>
        </div>
